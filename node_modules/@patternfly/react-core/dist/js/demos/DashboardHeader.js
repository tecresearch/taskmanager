    ...
    return (react_1.default.createElement(components_1.Masthead, null,
        react_1.default.createElement(components_1.MastheadMain, null,
            ...
            react_1.default.createElement(components_1.MastheadBrand, null,
                react_1.default.createElement(components_1.MastheadLogo, null,
        ...
        react_1.default.createElement(components_1.MastheadContent, null,
            react_1.default.createElement(components_1.Toolbar, { id: "toolbar", isStatic: true },
                react_1.default.createElement(components_1.ToolbarContent, null,
                    react_1.default.createElement(components_1.ToolbarGroup, { variant: "action-group-plain", align: { default: 'alignEnd' }, gap: { default: 'gapNone', md: 'gapMd' } }, notificationBadge !== null && notificationBadge !== void 0 ? notificationBadge : (react_1.default.createElement(components_1.ToolbarItem, null,
                        ...
                        react_1.default.createElement(components_1.ToolbarGroup, { variant: "action-group-plain", visibility: { default: 'hidden', lg: 'visible' } },
                        ...
                        react_1.default.createElement(components_1.ToolbarItem, { visibility: { default: 'hidden', md: 'visible', lg: 'hidden' } },
                            react_1.default.createElement(components_1.Dropdown, { isOpen: isKebabDropdownOpen, onSelect: onKebabDropdownSelect, onOpenChange: setIsKebabDropdownOpen, popperProps: { position: 'right' }, toggle: (toggleRef) => (react_1.default.createElement(components_1.MenuToggle, { ref: toggleRef, isExpanded: isKebabDropdownOpen, onClick: onKebabDropdownToggle, variant: "plain", "aria-label": "Settings and help", icon: react_1.default.createElement(ellipsis_v_icon_1.default, { "aria-hidden": "true" }) })) },
                        ...
                        react_1.default.createElement(components_1.ToolbarItem, { visibility: { md: 'hidden' } },
                            react_1.default.createElement(components_1.Dropdown, { isOpen: isFullKebabDropdownOpen, onSelect: onFullKebabSelect, onOpenChange: setIsFullKebabDropdownOpen, popperProps: { position: 'right' }, toggle: (toggleRef) => (react_1.default.createElement(components_1.MenuToggle, { ref: toggleRef, isExpanded: isFullKebabDropdownOpen, onClick: onFullKebabToggle, variant: "plain", "aria-label": "Toolbar menu", icon: react_1.default.createElement(ellipsis_v_icon_1.default, { "aria-hidden": "true" }) })) },
                    ...
                    react_1.default.createElement(components_1.ToolbarItem, { visibility: { default: 'hidden', md: 'visible' } },
                        react_1.default.createElement(components_1.Dropdown, { isOpen: isDropdownOpen, onSelect: onDropdownSelect, onOpenChange: setIsDropdownOpen, popperProps: { position: 'right' }, toggle: (toggleRef) => (react_1.default.createElement(components_1.MenuToggle, { ref: toggleRef, isExpanded: isDropdownOpen, onClick: onDropdownToggle, icon: react_1.default.createElement(components_1.Avatar, { src: avatarImg_svg_1.default, alt: "", size: "sm" }) }, "Ned Username")) },
                            react_1.default.createElement(components_1.DropdownList, null, userDropdownItems))))))));
};
