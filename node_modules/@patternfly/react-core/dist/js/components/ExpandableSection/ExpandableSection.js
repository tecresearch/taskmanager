...
class ExpandableSection extends React.Component {
    ...
    render() {
        ...
        const expandableToggle = !isDetached && (React.createElement("div", { className: `${expandable_section_1.default.expandableSection}__toggle` },
            React.createElement(Button_1.Button, Object.assign({ variant: "link" }, (variant === ExpandableSectionVariant.truncate && { isInline: true }), { "aria-expanded": propOrStateIsExpanded, "aria-controls": uniqueContentId, id: uniqueToggleId, onClick: (event) => onToggle(event, !propOrStateIsExpanded) }, (variant !== ExpandableSectionVariant.truncate && {
                icon: (React.createElement("span", { className: (0, react_styles_1.css)(expandable_section_1.default.expandableSectionToggleIcon) },
