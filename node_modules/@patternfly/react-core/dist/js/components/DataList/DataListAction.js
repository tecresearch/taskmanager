...
const DataListAction = (_a) => {
    ...
    return (React.createElement("div", Object.assign({ className: (0, react_styles_1.css)(data_list_1.default.dataListItemAction, (0, util_1.formatBreakpointMods)(visibility, data_list_1.default), className) }, props), children));
};
