...
const WizardToggle = ({ steps, activeStep, footer, nav, isNavExpanded, toggleNavExpanded, 'aria-label': ariaLabel = 'Wizard toggle' }) => {
    ...
    const bodyContent = steps.map((step) => {
        ...
        return (react_1.default.createElement(react_1.default.Fragment, { key: step.id },
            (activeStep === null || activeStep === void 0 ? void 0 : activeStep.id) === step.id && react_1.default.createElement(WizardBody_1.WizardBody, Object.assign({}, body), children),
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("button", { onClick: toggleNavExpanded, className: (0, react_styles_1.css)(wizard_1.default.wizardToggle, isNavExpanded && 'pf-m-expanded'), "aria-label": ariaLabel, "aria-expanded": isNavExpanded },
            react_1.default.createElement("span", { className: (0, react_styles_1.css)(wizard_1.default.wizardToggleList) },
                react_1.default.createElement("span", { className: (0, react_styles_1.css)(wizard_1.default.wizardToggleListItem, isActiveStepStatus === 'error' && wizard_1.default.modifiers.danger, isActiveStepStatus === 'success' && wizard_1.default.modifiers.success) },
                    ...
                    isActiveStepStatus === 'success' && (react_1.default.createElement("span", { className: (0, react_styles_1.css)(wizard_1.default.wizardToggleStatusIcon) },
                        react_1.default.createElement(check_circle_icon_1.default, null))),
                    isActiveStepStatus !== 'success' && isActiveStepStatus !== 'error' && (react_1.default.createElement("span", { className: (0, react_styles_1.css)(wizard_1.default.wizardToggleNum) }, wizardToggleIndex)),
                    ' ',
