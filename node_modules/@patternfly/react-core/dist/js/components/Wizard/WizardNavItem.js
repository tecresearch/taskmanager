...
const WizardNavItem = (_a) => {
    ...
    return (React.createElement("li", Object.assign({ className: (0, react_styles_1.css)(wizard_1.default.wizardNavItem, isExpandable && wizard_1.default.modifiers.expandable, isExpandable && isExpanded && wizard_1.default.modifiers.expanded, className) }, props),
        React.createElement(NavItemComponent, Object.assign({}, (NavItemComponent === 'a'
            ...
            }, className: (0, react_styles_1.css)(wizard_1.default.wizardNavLink, isCurrent && wizard_1.default.modifiers.current, isDisabled && wizard_1.default.modifiers.disabled, status === types_1.WizardNavItemStatus.Error && wizard_1.default.modifiers.danger, status === types_1.WizardNavItemStatus.Success && wizard_1.default.modifiers.success), "aria-disabled": isDisabled ? true : null, "aria-current": isCurrent && !children ? 'step' : false }, (isExpandable && { 'aria-expanded': isExpanded }), ouiaProps),
            status !== types_1.WizardNavItemStatus.Default && (React.createElement(React.Fragment, null,
                ...
                React.createElement("span", { className: (0, react_styles_1.css)(wizard_1.default.wizardNavLinkStatusIcon) },
                    status === types_1.WizardNavItemStatus.Error && React.createElement(exclamation_circle_icon_1.default, null),
                    status === types_1.WizardNavItemStatus.Success && React.createElement(check_circle_icon_1.default, null)))),
