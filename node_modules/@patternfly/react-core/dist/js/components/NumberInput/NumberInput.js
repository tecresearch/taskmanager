    ...
    return (React.createElement("div", Object.assign({ 
        ...
        React.createElement(InputGroup_1.InputGroup, null,
            React.createElement(InputGroup_1.InputGroupItem, null,
                React.createElement(Button_1.Button, Object.assign({ variant: "control", "aria-label": minusBtnAriaLabel, isDisabled: isDisabled || (typeof value === 'number' ? value : DEFAULT_VALUE) <= min, onClick: (evt) => onMinus(evt, inputName), icon: React.createElement("span", { className: (0, react_styles_1.css)(number_input_1.default.numberInputIcon) },
                        React.createElement(minus_icon_1.default, { "aria-hidden": "true" })) }, minusBtnProps))),
            React.createElement(InputGroup_1.InputGroupItem, null,
            ...
            React.createElement(InputGroup_1.InputGroupItem, null,
                React.createElement(Button_1.Button, Object.assign({ variant: "control", "aria-label": plusBtnAriaLabel, isDisabled: isDisabled || (typeof value === 'number' ? value : DEFAULT_VALUE) >= max, onClick: (evt) => onPlus(evt, inputName), icon: React.createElement("span", { className: (0, react_styles_1.css)(number_input_1.default.numberInputIcon) },
                        React.createElement(plus_icon_1.default, { "aria-hidden": "true" })) }, plusBtnProps)))),
