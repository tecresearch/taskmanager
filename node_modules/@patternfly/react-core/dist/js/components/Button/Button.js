...
const ButtonBase = (_a) => {
    ...
    const _icon = icon && (React.createElement("span", { className: (0, react_styles_1.css)(button_1.default.buttonIcon, children && button_1.default.modifiers[isIconAlignedAtEnd ? 'end' : 'start']) }, icon));
    const _children = children && React.createElement("span", { className: (0, react_styles_1.css)('pf-v6-c-button__text') }, children);
