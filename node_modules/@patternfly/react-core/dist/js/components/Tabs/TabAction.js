...
const TabActionBase = (_a) => {
    ...
    return (React.createElement("span", { className: (0, react_styles_1.css)(tabs_1.default.tabsItemAction, className) },
        React.createElement(Button_1.Button, Object.assign({ ref: innerRef, type: "button", variant: "plain", "aria-label": ariaLabel, onClick: onClick, isDisabled: isDisabled, icon: React.createElement("span", { className: (0, react_styles_1.css)(tabs_1.default.tabsItemActionIcon) }, children) }, (0, helpers_1.getOUIAProps)(exports.TabAction.displayName, ouiaId, ouiaSafe), props))));
};
