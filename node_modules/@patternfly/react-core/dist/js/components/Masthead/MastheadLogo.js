...
const MastheadLogo = (_a) => {
    ...
    return (React.createElement(Component, Object.assign({ className: (0, react_styles_1.css)(masthead_1.default.mastheadLogo, className) }, (Component === 'a' && { tabIndex: 0 }), props), children));
};
