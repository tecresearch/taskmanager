...
export declare const PageGroup: {
    ({ className, children, stickyOnBreakpoint, isFilled, hasShadowTop, hasShadowBottom, hasOverflowScroll, "aria-label": ariaLabel, ...props }: PageGroupProps): React.JSX.Element;
    displayName: string;
};
