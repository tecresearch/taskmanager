...
class Page extends React.Component {
    ...
    render() {
        ...
        let nav = null;
        if (horizontalSubnav) {
            nav = (React.createElement("div", { className: (0, react_styles_1.css)(page_1.default.pageMainSubnav, isHorizontalSubnavWidthLimited && page_1.default.modifiers.limitWidth) },
                React.createElement(PageBody_1.PageBody, null, horizontalSubnav)));
        }
        const crumb = breadcrumb ? (React.createElement(PageBreadcrumb_1.PageBreadcrumb, { stickyOnBreakpoint: breadcrumbProps === null || breadcrumbProps === void 0 ? void 0 : breadcrumbProps.stickyOnBreakpoint, isWidthLimited: isBreadcrumbWidthLimited },
            React.createElement(PageBody_1.PageBody, null, breadcrumb))) : null;
        ...
        const main = (React.createElement("div", { className: (0, react_styles_1.css)(page_1.default.pageMainContainer, isContentFilled && page_1.default.modifiers.fill) },
            React.createElement(Component, { ref: this.mainRef, role: role, id: mainContainerId, className: (0, react_styles_1.css)(page_1.default.pageMain), tabIndex: mainTabIndex, "aria-label": mainAriaLabel },
                group,
                !isHorizontalSubnavGrouped && nav,
                banner,
                !isBreadcrumbGrouped && crumb,
            ...
            React.createElement("div", Object.assign({ ref: this.pageRef }, rest, { className: (0, react_styles_1.css)(page_1.default.page, width !== null && height !== null && 'pf-m-resize-observer', width !== null && `pf-m-breakpoint-${getBreakpoint(width)}`, height !== null && `pf-m-height-breakpoint-${getVerticalBreakpoint(height)}`, className) }),
                ...
                notificationDrawer && (React.createElement("div", { className: (0, react_styles_1.css)(page_1.default.pageDrawer) },
                    React.createElement(Drawer_1.Drawer, { isExpanded: isNotificationDrawerExpanded, onExpand: (event) => onNotificationDrawerExpand(event) },
                        React.createElement(Drawer_1.DrawerContent, { panelContent: panelContent }, main)))),
