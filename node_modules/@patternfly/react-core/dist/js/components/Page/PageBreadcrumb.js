...
const PageBreadcrumb = (_a) => {
    ...
    return (React.createElement("section", Object.assign({ className: (0, react_styles_1.css)(page_1.default.pageMainBreadcrumb, (0, util_1.formatBreakpointMods)(stickyOnBreakpoint, page_1.default, 'sticky-', getVerticalBreakpoint(height), true), isWidthLimited && page_1.default.modifiers.limitWidth, hasShadowTop && page_1.default.modifiers.shadowTop, hasShadowBottom && page_1.default.modifiers.shadowBottom, hasOverflowScroll && page_1.default.modifiers.overflowScroll, className) }, (hasOverflowScroll && { tabIndex: 0 }), { "aria-label": ariaLabel }, props), hasBodyWrapper ? React.createElement(PageBody_1.PageBody, null, children) : children));
};
