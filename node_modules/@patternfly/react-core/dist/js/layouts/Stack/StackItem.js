...
const StackItem = (_a) => {
    ...
    return (React.createElement(Component, Object.assign({}, props, { className: (0, react_styles_1.css)(stack_1.default.stackItem, isFilled && stack_1.default.modifiers.fill, className) }), children));
};
