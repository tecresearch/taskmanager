...
class Page extends React.Component {
    ...
    render() {
        ...
        let nav = null;
        if (horizontalSubnav) {
            nav = (React.createElement("div", { className: css(styles.pageMainSubnav, isHorizontalSubnavWidthLimited && styles.modifiers.limitWidth) },
                React.createElement(PageBody, null, horizontalSubnav)));
        }
        const crumb = breadcrumb ? (React.createElement(PageBreadcrumb, { stickyOnBreakpoint: breadcrumbProps === null || breadcrumbProps === void 0 ? void 0 : breadcrumbProps.stickyOnBreakpoint, isWidthLimited: isBreadcrumbWidthLimited },
            React.createElement(PageBody, null, breadcrumb))) : null;
        ...
        const main = (React.createElement("div", { className: css(styles.pageMainContainer, isContentFilled && styles.modifiers.fill) },
            React.createElement(Component, { ref: this.mainRef, role: role, id: mainContainerId, className: css(styles.pageMain), tabIndex: mainTabIndex, "aria-label": mainAriaLabel },
                group,
                !isHorizontalSubnavGrouped && nav,
                banner,
                !isBreadcrumbGrouped && crumb,
            ...
            React.createElement("div", Object.assign({ ref: this.pageRef }, rest, { className: css(styles.page, width !== null && height !== null && 'pf-m-resize-observer', width !== null && `pf-m-breakpoint-${getBreakpoint(width)}`, height !== null && `pf-m-height-breakpoint-${getVerticalBreakpoint(height)}`, className) }),
                ...
                notificationDrawer && (React.createElement("div", { className: css(styles.pageDrawer) },
                    React.createElement(Drawer, { isExpanded: isNotificationDrawerExpanded, onExpand: (event) => onNotificationDrawerExpand(event) },
                        React.createElement(DrawerContent, { panelContent: panelContent }, main)))),
