...
export declare const PageBreadcrumb: {
    ({ className, children, isWidthLimited, stickyOnBreakpoint, hasShadowTop, hasShadowBottom, hasOverflowScroll, "aria-label": ariaLabel, hasBodyWrapper, ...props }: PageBreadcrumbProps): React.JSX.Element;
    displayName: string;
};
