            ...
            React.createElement(Component, Object.assign({ "aria-label": ariaLabel, className: css(styles.tabs, isFilled && styles.modifiers.fill, isSubtab && styles.modifiers.subtab, isVertical && styles.modifiers.vertical, isVertical && expandable && formatBreakpointMods(expandable, styles), isVertical && expandable && isExpandedLocal && styles.modifiers.expanded, isBox && styles.modifiers.box, showScrollButtons && styles.modifiers.scrollable, usePageInsets && styles.modifiers.pageInsets, hasNoBorderBottom && styles.modifiers.noBorderBottom, formatBreakpointMods(inset, styles), variantStyle[variant], hasOverflowTab && styles.modifiers.overflow, className) }, getOUIAProps(Tabs.displayName, ouiaId !== undefined ? ouiaId : this.state.ouiaStateId, ouiaSafe), { id: id && id }, props),
                expandable && isVertical && (React.createElement(GenerateId, null, (randomId) => (React.createElement("div", { className: css(styles.tabsToggle) },
                    React.createElement("div", { className: css(styles.tabsToggleButton) },
                        React.createElement(Button, { onClick: (event) => toggleTabs(event, !isExpandedLocal), variant: "plain", "aria-label": toggleAriaLabel, "aria-expanded": isExpandedLocal, id: `${randomId}-button`, "aria-labelledby": `${randomId}-text ${randomId}-button`, icon: React.createElement("span", { className: css(styles.tabsToggleIcon) },
                                React.createElement(AngleRightIcon, null)) }, toggleText && React.createElement("span", { id: `${randomId}-text` }, toggleText))))))),
                renderScrollButtons && (React.createElement("div", { className: css(styles.tabsScrollButton) },
                    React.createElement(Button, { "aria-label": backScrollAriaLabel || leftScrollAriaLabel, onClick: this.scrollBack, isDisabled: disableBackScrollButton, "aria-hidden": disableBackScrollButton, ref: this.leftScrollButtonRef, variant: "plain", icon: React.createElement(AngleLeftIcon, null) }))),
                ...
                renderScrollButtons && (React.createElement("div", { className: css(styles.tabsScrollButton) },
                    React.createElement(Button, { "aria-label": forwardScrollAriaLabel || rightScrollAriaLabel, onClick: this.scrollForward, isDisabled: disableForwardScrollButton, "aria-hidden": disableForwardScrollButton, variant: "plain", icon: React.createElement(AngleRightIcon, null) }))),
                onAdd !== undefined && (React.createElement("span", { className: css(styles.tabsAdd) },
                    React.createElement(Button, { variant: "plain", "aria-label": addButtonAriaLabel || 'Add tab', onClick: onAdd, icon: React.createElement(PlusIcon, null) })))),
            filteredChildren
