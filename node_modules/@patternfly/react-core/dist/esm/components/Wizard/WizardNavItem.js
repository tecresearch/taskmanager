...
export const WizardNavItem = (_a) => {
    ...
    return (React.createElement("li", Object.assign({ className: css(styles.wizardNavItem, isExpandable && styles.modifiers.expandable, isExpandable && isExpanded && styles.modifiers.expanded, className) }, props),
        React.createElement(NavItemComponent, Object.assign({}, (NavItemComponent === 'a'
            ...
            }, className: css(styles.wizardNavLink, isCurrent && styles.modifiers.current, isDisabled && styles.modifiers.disabled, status === WizardNavItemStatus.Error && styles.modifiers.danger, status === WizardNavItemStatus.Success && styles.modifiers.success), "aria-disabled": isDisabled ? true : null, "aria-current": isCurrent && !children ? 'step' : false }, (isExpandable && { 'aria-expanded': isExpanded }), ouiaProps),
            status !== WizardNavItemStatus.Default && (React.createElement(React.Fragment, null,
                ...
                React.createElement("span", { className: css(styles.wizardNavLinkStatusIcon) },
                    ...
                    status === WizardNavItemStatus.Success && React.createElement(CheckCircleIcon, null)))),
