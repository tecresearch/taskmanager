...
export const WizardToggle = ({ steps, activeStep, footer, nav, isNavExpanded, toggleNavExpanded, 'aria-label': ariaLabel = 'Wizard toggle' }) => {
    ...
    const bodyContent = steps.map((step) => {
        ...
        return (React.createElement(React.Fragment, { key: step.id },
            (activeStep === null || activeStep === void 0 ? void 0 : activeStep.id) === step.id && React.createElement(WizardBody, Object.assign({}, body), children),
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("button", { onClick: toggleNavExpanded, className: css(styles.wizardToggle, isNavExpanded && 'pf-m-expanded'), "aria-label": ariaLabel, "aria-expanded": isNavExpanded },
            React.createElement("span", { className: css(styles.wizardToggleList) },
                React.createElement("span", { className: css(styles.wizardToggleListItem, isActiveStepStatus === 'error' && styles.modifiers.danger, isActiveStepStatus === 'success' && styles.modifiers.success) },
                    ...
                    isActiveStepStatus === 'success' && (React.createElement("span", { className: css(styles.wizardToggleStatusIcon) },
                        React.createElement(CheckCircleIcon, null))),
                    isActiveStepStatus !== 'success' && isActiveStepStatus !== 'error' && (React.createElement("span", { className: css(styles.wizardToggleNum) }, wizardToggleIndex)),
                    ' ',
