...
export const TextInputGroup = (_a) => {
    ...
    return (React.createElement(TextInputGroupContext.Provider, { value: { isDisabled, validated } },
        React.createElement("div", Object.assign({ ref: textInputGroupRef, className: css(styles.textInputGroup, isDisabled && styles.modifiers.disabled, isPlain && styles.modifiers.plain, validated && styles.modifiers[validated], className) }, props), children)));
};
