...
exports.c_form_control = {
  ".pf-v6-c-form-control": {
    ...
    "c_form_control_m_success_PaddingInlineEnd": {
      ...
      "value": "calc(0.875rem + 1rem + 0.5rem)",
      "values": [
        "calc(--pf-v6-c-form-control__icon--FontSize + --pf-v6-c-form-control--inset--base + --pf-v6-c-form-control--ColumnGap)",
        "calc(--pf-t--global--icon--size--font--body--default + --pf-t--global--spacer--control--horizontal--default + --pf-t--global--spacer--gap--text-to-element--default)",
        "calc(--pf-t--global--font--size--body--default + --pf-t--global--spacer--md + --pf-t--global--spacer--sm)",
        "calc(--pf-t--global--font--size--sm + --pf-t--global--spacer--300 + --pf-t--global--spacer--200)",
        "calc(--pf-t--global--font--size--200 + 1rem + 0.5rem)",
    ...
    "c_form_control_m_icon_PaddingInlineEnd": {
      ...
      "value": "calc(1rem + 0.875rem + calc(1rem / 2))",
      "values": [
        "calc(--pf-v6-c-form-control--inset--base + --pf-v6-c-form-control--m-icon--icon--width + --pf-v6-c-form-control--m-icon--icon--spacer)",
        "calc(--pf-t--global--spacer--control--horizontal--default + --pf-v6-c-form-control--FontSize + calc(--pf-t--global--spacer--control--horizontal--default / 2))",
        "calc(--pf-t--global--spacer--md + --pf-t--global--font--size--body--default + calc(--pf-t--global--spacer--md / 2))",
        "calc(--pf-t--global--spacer--300 + --pf-t--global--font--size--sm + calc(--pf-t--global--spacer--300 / 2))",
        "calc(1rem + --pf-t--global--font--size--200 + calc(1rem / 2))",
    ...
    "c_form_control_m_icon_icon_PaddingInlineEnd": {
      ...
      "value": "calc(1rem + 0.875rem + calc(1rem / 2) + 0.875rem + calc(1rem / 2))",
      "values": [
        ...
        "calc(--pf-t--global--spacer--control--horizontal--default + --pf-v6-c-form-control--FontSize + calc(--pf-t--global--spacer--control--horizontal--default / 2) + --pf-v6-c-form-control--FontSize + calc(--pf-t--global--spacer--control--horizontal--default / 2))",
        "calc(--pf-t--global--spacer--md + --pf-t--global--font--size--body--default + calc(--pf-t--global--spacer--md / 2) + --pf-t--global--font--size--body--default + calc(--pf-t--global--spacer--md / 2))",
        "calc(--pf-t--global--spacer--300 + --pf-t--global--font--size--sm + calc(--pf-t--global--spacer--300 / 2) + --pf-t--global--font--size--sm + calc(--pf-t--global--spacer--300 / 2))",
        "calc(1rem + --pf-t--global--font--size--200 + calc(1rem / 2) + --pf-t--global--font--size--200 + calc(1rem / 2))",
    ...
    "c_form_control__select_m_success_m_status_PaddingInlineEnd": {
      ...
      "value": "calc((0.875rem * 2) + 1rem + 1rem + 1rem)",
      "values": [
        "calc((--pf-v6-c-form-control__icon--FontSize * 2) + --pf-v6-c-form-control__utilities--Gap + --pf-v6-c-form-control__toggle-icon--PaddingInlineEnd + --pf-v6-c-form-control__toggle-icon--PaddingInlineStart)",
        "calc((--pf-t--global--icon--size--font--body--default * 2) + --pf-t--global--spacer--gap--group--horizontal + --pf-v6-c-form-control--inset--base + --pf-v6-c-form-control--inset--base)",
        "calc((--pf-t--global--font--size--body--default * 2) + --pf-t--global--spacer--md + --pf-t--global--spacer--control--horizontal--default + --pf-t--global--spacer--control--horizontal--default)",
        "calc((--pf-t--global--font--size--sm * 2) + --pf-t--global--spacer--300 + --pf-t--global--spacer--md + --pf-t--global--spacer--md)",
        "calc((--pf-t--global--font--size--200 * 2) + 1rem + --pf-t--global--spacer--300 + --pf-t--global--spacer--300)",
